...
>
> **Fuente de verdad.** El catálogo (nombre, resultado que habilita, pareja líder, sprints
> y requisitos) vive en
> [`Plan de ejecucion/07` · «Épicas»](<../../Plan de ejecucion/07-backlog-ejecutable-sprints.md>)
> y en [30 · §4](../30-arranque-agil-y-sprint-0.md). Estos archivos son el **formato de
> presentación** de cada épica; si un dato no coincide, **manda la fuente**.
>
> **Reglas de cátedra.**
...
| Épica | Ficha | Nombre | Pareja líder | Sprints | Requisitos (orientativo) |
|---|---|---|---|---|---|
| **EP-01** | [`ep-01.md`](ep-01.md) | Plataforma, contratos e integración | P1 | S1, S3, S6, S10, S19 | RF-NFR-01/03/04/09/10; contratos v1 |
| **EP-02** | [`ep-02.md`](ep-02.md) | AI Gateway, modelos y resiliencia | P2 | S3, S8, S9 | RF-IA-22/23/24/35 |
| **EP-03** | [`ep-03.md`](ep-03.md) | Golden set y referencia humana | P5 + P4 | S1, S2 | RF-IA-29/30 a 36 |
| **EP-04** | [`ep-04.md`](ep-04.md) | Calibración y gobernanza del modelo | P4 | S3, S4, S8 | RF-IA-30 a 36; PAR-14 |
| **EP-05** | [`ep-05.md`](ep-05.md) | Tutor seguro y guardarraíles | P3 + P2 | S5 | RF-IA-01/02/04/19/20 |
| **EP-06** | [`ep-06.md`](ep-06.md) | Evaluación, score y auditoría académica | P4 + P1 | S6, S7 | RF-IA-12 a 18/25/27/34 |
| **EP-07** | [`ep-07.md`](ep-07.md) | Operación, cuotas y observabilidad | P2 + P1 | S9, S10 | RF-IA-22/25; RF-NFR-01/03/04 |
| **EP-08** | [`ep-08.md`](ep-08.md) | Moderación integrada (F2) | P3 + P2 + P1 | S11–S13 | RF-CHT-09 a 14 |
| **EP-09** | [`ep-09.md`](ep-09.md) | RAG y consulta de material (F3) | P5 + P3 | S14–S16 | RF-IA-06/07/08 |
| **EP-10** | [`ep-10.md`](ep-10.md) | Personalización y agente (F3) | P5 + P4 + P3 | S17–S18 | RF-DES-05; RF-CHT-05/08 |
...
> definen en [23 · §3](../23-plan-construccion-producto-llm.md).
