...
> **Lectura histórica.** Las respuestas técnicas que nombren `ai-service`, `ms-evaluacion-llm`, `/ai/*` o `trace_id` explican decisiones previas. Para implementación vigente usar `llm-service`, contratos v1 y [00](00-fuentes-de-verdad-y-convenciones.md).
