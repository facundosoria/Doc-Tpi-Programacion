...
> **Correlación vigente.** Los nuevos modelos de datos y contratos usan `X-Request-Id` y `traceparent`; `trace_id` es terminología histórica y no debe agregarse a nuevas tablas ni respuestas. Ver [00](00-fuentes-de-verdad-y-convenciones.md).
