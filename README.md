...
| 31 | [SPIKE: Decodificación de Imágenes y RAG Multi-Fuente](docs/31-spike-decodificacion-imagenes-y-rag-multifuente.md) | 🔬 **Investigación 2026**: Decodificación 100% sin IA de diagramas de arquitectura y flujo con OpenCV + Tess4J + JGraphT, persistencia PostgreSQL + pgvector (Supabase HNSW 768d) y filtrado interactivo NotebookLM. |
