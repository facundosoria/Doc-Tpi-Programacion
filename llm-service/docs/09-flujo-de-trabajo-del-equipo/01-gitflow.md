...
Este repositorio desarrolla `llm-service` con un techo duro de **[5 sprints de dos semanas](../07-planificacion-y-trabajo-equipo/05-plan-de-cinco-sprints.md)** (el horizonte de "tres fases y 19 sprints" quedó retirado el 2026-09-13). Se trabaja con un backlog y cinco parejas efectivas; las ramas representan integración, no equipos separados.
...
El detalle operativo está en [WORKFLOW_DIARIO](02-workflow-diario.md), el [playbook](../07-planificacion-y-trabajo-equipo/06-playbook-de-construccion.md)y el [backlog](../07-planificacion-y-trabajo-equipo/04-backlog-ejecutable.md)
