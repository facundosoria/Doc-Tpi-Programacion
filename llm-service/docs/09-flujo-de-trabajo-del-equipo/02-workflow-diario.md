...
1. Leer el sprint en el [backlog ejecutable](../07-planificacion-y-trabajo-equipo/04-backlog-ejecutable.md)
2. Comprobar requisitos previos, contrato, fuente normativa y dependencia externa.
3. Verificar DoR en el [playbook](../07-planificacion-y-trabajo-equipo/06-playbook-de-construccion.md)
