...
| 4 | Resto de esta documentación | Explicación y detalle; no puede contradecir las fuentes anteriores. |

El material de investigación y apoyo bajo `08-preguntas-investigacion-y-sincronizaciones/04-investigacion-y-material/` no participa de esta jerarquía: da contexto, pero una regla vigente nunca se decide ahí.
...
Los contratos vigentes están en [`contracts/llm-service-v1.openapi.yaml`](../contracts/llm-service.openapi.yaml)y [`contracts/llm-service-v1.asyncapi.yaml`](../contracts/llm-service.asyncapi.yaml). La cobertura de requisitos vive en [21](04-matriz-trazabilidad.md)
