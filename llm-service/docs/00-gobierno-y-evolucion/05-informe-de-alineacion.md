...
Los detalles de operaciones, cuerpos y respuestas están en [OpenAPI v1](../contracts/llm-service.openapi.yaml); la integración asíncrona se encuentra en [AsyncAPI v1](../contracts/llm-service.asyncapi.yaml)
