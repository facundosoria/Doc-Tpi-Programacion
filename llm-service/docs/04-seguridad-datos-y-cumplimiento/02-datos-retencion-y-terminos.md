...
> **Correlación vigente.** Los nuevos modelos de datos y contratos usan `X-Request-Id` y `traceparent`; `trace_id` es terminología histórica y no debe agregarse a nuevas tablas ni respuestas. Ver [00](../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md)
...
| **Enviarla a un free tier que puede entrenar con ella** | 🔴 **Es el punto C-2 de [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), sin resolver** |
...
**El punto 5 merece atención**, porque cruza la frontera entre equipos ([01](../01-vision-alcance-y-entrega/01-problema-y-alcance.md)
