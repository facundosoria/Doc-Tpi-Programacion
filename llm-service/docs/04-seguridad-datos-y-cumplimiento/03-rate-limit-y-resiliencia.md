...
> [EP-07](../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/epicas/ep-07.md)([`historias/ep-07/h02.md`](../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/ep-07/h02.md)
> [08 P-12](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)) — el back office (Tema 12) sería quien lo configura.
...
> Spring AI). En el servicio real el cliente es **langchain4j** ([ADR-016](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)
