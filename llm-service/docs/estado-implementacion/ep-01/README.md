...
| H06 | Tests y cobertura | 🟢 | `mvn verify` en verde con 90 %+ exigido por el gate: cobertura total ≈93 % (unit + ITs) con ~660 tests. El pom ahora acumula los ITs en `jacoco.exec` (antes el reporte los ignoraba y mostraba ≈62 %). Piso de JaCoCo subido de 55 % a 90 %. CI en `.github/workflows/llm-service-ci.yml` |
