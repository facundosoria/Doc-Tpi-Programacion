...
> §3, [`llm-service/CORRECCIONES-SUGERIDAS.md`](../../../llm-service/CORRECCIONES-SUGERIDAS.md)
> ítem 2.
...
|---|---|---|---|
| [s03-h01](s03-h01.md) | Correr y activar una calibración de curso con métrica PAR-14 | 🔴 | Esqueleto sólido; ningún run puede pasar de `RUNNING` porque falta H10 (EP-02) |
