...
> **Propósito:** Bocetos de baja fidelidad (wireframes) requeridos por la cátedra ([29 · §2.2 y §10](../../../07-planificacion-y-trabajo-equipo/08-guia-de-historias-de-usuario.md)) para la historia de usuario **`LLM-S01-H07`** (*Pantalla docente mínima del golden set*).
>
...
>
> **Demo interactiva funcional:** El comportamiento dinámico de estos wireframes, la rúbrica 5D y el evaluador pueden probarse en la demo web interactiva ubicada en [`Demos/Golden Set/index.html`](golden-set-calibration-demo.html).
