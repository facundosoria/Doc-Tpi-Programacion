...
> **Perímetro técnico vigente.** Los guardarraíles viven en `llm-service`, expuesto solo por Gateway bajo `/api/llm/**`. La identidad y correlación confiables son las declaradas en [00](../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md).
...
(por eso el tutor va en un modelo rápido — ver [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md)). El streaming con
...
| **Verificar la política de retención del proveedor** | Y en particular **la del free tier**, que suele permitir entrenar con tus datos. Ver [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §4b |
...
> ni al prompt del evaluador. Ver [00](../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md) y
> [32](../../../03-capacidades-de-ia/golden-set-y-calibracion/02-especificacion-funcional.md).
...
prácticos: no podés bloquear algo que el alumno ya está leyendo. Ver [05](../../../04-seguridad-datos-y-cumplimiento/01-seguridad-y-guardarrailes.md) §3.

**2. Te pone en el camino de respuesta del tutor.** Es el argumento de
[02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) §2b para el alcance del Tema 07: la cátedra te asignó la
...
B-1 de [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md).
