...
> Tema 05. Detalle en [17](../../../contracts/00-mapa-de-integracion.md) y 18 (histórico, retirado).
...
La [U1 de Front End](../../../02-arquitectura-y-plataforma/02-sincronizacion-arquitectura-y-despliegue.md) enseña **Nginx como gateway** de
...
lenguaje— está en [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md).**
...
**El lenguaje cambia las herramientas, no el diseño.** Todo lo de [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) vale igual.
