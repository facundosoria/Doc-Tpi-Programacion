...
> **Alcance.** La ingesta y el RAG pedagógico se documentan para Fase 3. No son prerrequisito del tutor MVP, que recibe contexto confiable del servicio dueño del desafío según [00](../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md).
...
> [06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md), Parte 6, para el análisis completo y la recomendación actualizada.
...
> hacen falta ([06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md) Parte 1). Son canales distintos y no se mezclan
...
| **Decodificación de diagramas sin IA** | **OpenCV + Tess4J + JGraphT** | Pipeline determinístico 100% sin IA (ver [31](../../../03-capacidades-de-ia/rag-e-ingesta/02-spike-rag-multifuente.md)) |
