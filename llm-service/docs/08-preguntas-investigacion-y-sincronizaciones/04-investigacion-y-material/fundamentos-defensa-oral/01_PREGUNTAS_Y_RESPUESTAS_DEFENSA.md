...
> **Nota de terminología:** las respuestas técnicas que nombren `ai-service`, `ms-evaluacion-llm`, `/ai/*` o `trace_id` usan nombres anteriores; los vigentes son `llm-service`, contratos v1 y [`00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md`](../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md).
...
📄 [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) §4
...
📄 [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §3
...
📄 [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §4 y §8
...
📄 [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §4c
...
📄 [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md), [01](../../../01-vision-alcance-y-entrega/01-problema-y-alcance.md) §2
...
📄 [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) §7
...
📄 [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §1
...
📄 [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) §5
...
📄 [05](../../../04-seguridad-datos-y-cumplimiento/01-seguridad-y-guardarrailes.md) §3, ADR-009
...
📄 [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md), [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md)
...
📄 [10](../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md)
...
📄 [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §4b
...
📄 [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §4c
...
📄 [06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md) §4b
...
📄 [05](../../../04-seguridad-datos-y-cumplimiento/01-seguridad-y-guardarrailes.md) §4
...
📄 [07](../../../04-seguridad-datos-y-cumplimiento/02-datos-retencion-y-terminos.md) §6b
...
cada herramienta está en [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3.1.
...
lista.** Ver [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3.2.
...
producto, Parte C de [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)— y validar la calibración contra los 100
...
📄 [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3, ADR-012
...
| `temperature: 0` + `seed` (A-3 de [14](../../../08-preguntas-investigacion-y-sincronizaciones/02-sincronizacion-con-guia-didactica.md)) | No aplica: un clasificador ya es determinístico |
...
📄 ADR-012, [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3.5
...
1. **Latencia.** El presupuesto es < 300 ms ([02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md)) y un roundtrip HTTP se
...
3. **Datos.** Cuantos menos mensajes de alumnos viajen a un tercero, mejor
   ([07](../../../04-seguridad-datos-y-cumplimiento/02-datos-retencion-y-terminos.md)).
...
justificarían y los seis que no— está en [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.10.
...
📄 ADR-012, [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md), [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.0 y §2.10
...
[04](../../../03-capacidades-de-ia/02-funciones-de-ia.md)—, pero **contradice el contrato que ya escribimos**: `categorias` es un
...
📄 [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3.4b, [11](../../../00-gobierno-y-evolucion/03-glosario-y-metadata.md)
...
Las decisiones formales están en [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) como ADR; este documento es el
