...
> **Bus acordado.** Kafka es el bus compartido para eventos de integración. La cola de workers de `llm-service` sigue siendo interna y no se confunde con el bus. Los schemas y tópicos vigentes están en `contracts/llm-service.asyncapi.yaml`.
...
parciales al mismo tiempo?"*. Ver [06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md), pero el resumen es: **no pasa
...
> [`equipos/frontend-angular/contratos.md`](../../../contracts/equipos/frontend-angular.md) — acá queda
...
> También vive, copiado completo, en
> [`equipos/frontend-angular/contratos.md`](../../../contracts/equipos/frontend-angular.md) — es el
...
| **Modo examen** (RF-EXA-01) | Fase 3, pero su concurrencia ya está dimensionada en [06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md) |
