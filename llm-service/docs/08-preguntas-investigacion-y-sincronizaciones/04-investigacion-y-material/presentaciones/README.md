...
## Tres de las presentaciones necesitaron una revisión, y ya están alineadas

`mapa-conceptual-interactivo.html`, `guia-golden-set.html` e
`informe-gestion-modelos.html` se armaron con una versión anterior de la documentación, no con la
vigente. Eso las dejaba desalineadas en ocho puntos: el registro de ADR, el ADR-005 viejo con
FastAPI, los endpoints, la frecuencia de la detección de deriva, el costo total, el catálogo de
...
[`CORRECCIONES-SUGERIDAS.md`](CORRECCIONES-SUGERIDAS.md).**

## Qué se unificó

`defensa-39-slides.html` unifica dos decks distintos, con el mismo diseño y contenido
solapado: un deck base de 31 slides y otro de 14 slides, de los cuales 12 ya estaban en el
primero; **las 2 que faltaban se portaron**.
