...
📄 [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md), [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md)
...
| — | Tamaño del equipo | 🟢 **6 personas.** Reparto en [10](../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) |
| — | ¿Producto o demo? | 🟢 **Tiene que funcionar, pero primero demo local.** Plan de 4 semanas en [10](../../../01-vision-alcance-y-entrega/02-entregables-y-plan.md) |
...
Para que no se vuelva a discutir. Detalle en [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) y [09](../../../08-preguntas-investigacion-y-sincronizaciones/01-preguntas-y-respuestas.md).
...
|---|---|---|---|---|---|
| E-01 | **Las anclas de las 5 dimensiones** | [13](../../../03-capacidades-de-ia/03-rubricas-y-prompts.md) §3 | 📝 | 🔴 **Dos docentes**, ajustando sobre nuestro borrador | Paso 6 — al comparar puntajes |
...
| E-05 | Prompt del moderador | [13](../../../03-capacidades-de-ia/03-rubricas-y-prompts.md) §9 | 📝 | — | Fase 2 |
...
> está en [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md), Parte 3: dos docentes puntúan por separado, y **donde difieren
...
| # | Qué | Dónde | Marca | Quién lo define | Cuándo |
|---|---|---|---|---|---|
| E-15 | Nombres de campos y tablas | [11](../../../00-gobierno-y-evolucion/03-glosario-y-metadata.md) Parte B | 📝 | P5 | 🔴 Paso 2 — esta semana |
| E-16 | **Qué es un "mensaje trivial"** (¿menos de cuántos caracteres?) | [11](../../../00-gobierno-y-evolucion/03-glosario-y-metadata.md) Parte B | ⬜ | P3, ajustando contra el golden set | Paso 4 |
| E-17 | Las 7 colisiones del glosario | [11](../../../00-gobierno-y-evolucion/03-glosario-y-metadata.md) Parte A | 📝 | 🔴 **La sesión de integración**, no nosotros solos | Esta semana |
...
| E-22 | Umbrales de RF-IA-22 (15 / 60 / 20) | [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) D-8 | 📝 | ADMIN, con datos de uso real |
