...
> **Convención de trazabilidad.** El glosario canónico usa `traceparent` y `X-Request-Id`; toda aparición heredada de `trace_id` debe leerse como antecedente y migrarse al tocar el contrato o schema correspondiente.
...
> [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), Parte C.
...
decisión está en [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3.4b —pipeline contra cadena— y §2.3.4c.**
...
| **Circuit Breaker** | Corta las llamadas a un servicio que está fallando y las reintenta más tarde | Todos los proveedores. **Resilience4j**, elegido en [02](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) |
...
| **Buffer Interceptor** | Retiene la salida en streaming hasta poder validarla | Salvaguarda anti-fuga del tutor ([14](../../../08-preguntas-investigacion-y-sincronizaciones/02-sincronizacion-con-guia-didactica.md) A-1) |
...
> está en [04](../../../03-capacidades-de-ia/02-funciones-de-ia.md) §2.3.4b.

### Infraestructura y despliegue

Vocabulario de la [U1 de Front End](../../../02-arquitectura-y-plataforma/02-sincronizacion-arquitectura-y-despliegue.md). Van acá porque
...
| **Readiness / liveness** | Sondas que responden *¿puedo recibir tráfico?* y *¿sigo vivo?* | [06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md) Parte 7 §4. **El proveedor de LLM no entra** (ADR-014) |
...
> [06](../../../06-operacion-calidad-y-pruebas/01-operacion-e-ingenieria.md) dice *"si lo cambia un ADMIN sin pedir un deploy, va en la
