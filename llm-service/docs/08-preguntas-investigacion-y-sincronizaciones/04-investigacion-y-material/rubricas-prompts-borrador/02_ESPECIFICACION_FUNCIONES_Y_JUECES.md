...
- **`rubrica_correccion`** → se genera **junto con** la pregunta y alimenta al corrector
  ([04](../../../03-capacidades-de-ia/02-funciones-de-ia.md)). Generar la pregunta y su criterio de corrección en el mismo
...
4. **Es lo que hace aceptable un modelo barato.** El escenario B de [03](../../../03-capacidades-de-ia/01-modelos-costos-y-contexto.md) usa
...
registrado como pregunta abierta para el Product Owner en [08](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md).
...
1. **La rúbrica viene con la pregunta.** El generador ([04](../../../03-capacidades-de-ia/02-funciones-de-ia.md)) produce
