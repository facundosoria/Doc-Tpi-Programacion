...
> **Lectura histórica.** Las respuestas técnicas que nombren `ai-service`, `ms-evaluacion-llm`, `/ai/*` o `trace_id` explican decisiones previas. Para implementación vigente usar `llm-service`, contratos v1 y [00](../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md)
...
| `temperature: 0` + `seed` (A-3 de [14](02-sincronizacion-con-guia-didactica.md)) | No aplica: un clasificador ya es determinístico |
...
📄 ADR-012, [03](../03-capacidades-de-ia/01-modelos-costos-y-contexto.md).10
