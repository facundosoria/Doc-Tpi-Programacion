...
> [`epicas/ep-06.md`](../../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/epicas/ep-06.md) y de las recetas de
> [`35-backlog-ejecutable.md`](../../../07-planificacion-y-trabajo-equipo/04-backlog-ejecutable.md) (S6, S7), no de una ficha.
