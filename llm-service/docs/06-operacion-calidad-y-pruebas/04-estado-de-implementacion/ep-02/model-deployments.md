...
- **Épica tentativa:** EP-02 (tabla de
  [`verificacion-v2-golden-set-calibracion.md` · §1](../../../01-vision-alcance-y-entrega/03-entregas/verificacion-v2-golden-set-calibracion.md))
- **Código:** `ModelDeploymentController.java`
- **Evidencia:** [`CORRECCIONES-SUGERIDAS.md` ítem 3](../codigo-ejemplo/fuentes/CORRECCIONES-SUGERIDAS.md)
...
- `GET /api/llm/courses/{courseId}/model-deployments` (`listForCourse`) **sí lee la tabla real**
  ...
  ([08 · B-6/C-2](../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)).
- Ambos endpoints inyectan el `*Repository` directo en el controller, sin capa `application/`
  ...
  [`CORRECCIONES-SUGERIDAS.md` ítem 1](../codigo-ejemplo/fuentes/CORRECCIONES-SUGERIDAS.md)).
...
- El contrato v2 sí documenta `POST /api/llm/admin/model-adapters` (alta de adapter), pero **no
  ...
  [`CORRECCIONES-SUGERIDAS.md` ítem 12](../codigo-ejemplo/fuentes/CORRECCIONES-SUGERIDAS.md).
