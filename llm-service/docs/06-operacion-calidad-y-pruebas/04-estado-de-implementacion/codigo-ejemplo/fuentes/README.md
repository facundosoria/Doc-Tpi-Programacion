...
> [`docs/00-fuentes-de-verdad-y-convenciones.md`](../../../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md)
...
|---|---|---|---|
| [`ms-evaluacion-llm/`](../ms-evaluacion-llm.md) | **El equipo** · `facundosoria`, en `feat/qa-gate` | Esqueleto histórico a migrar a `llm-service` | Compila, pero no cumple aún el contrato v1 |
| [`lara-heredia-demo-llm-spring-ai/`](../lara-heredia-demo-llm-spring-ai.md) | **Lara Heredia** · `412181-HerediaLara`, en la rama `lara` | Una **demo funcional** de tutor socrático con Spring AI + Groq | Anda de punta a punta, pero es material de exploración |
...
Contexto de diseño: [`docs/02 · Arquitectura y stack`](../../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md).

Política de tests (cómo mockear el LLM y cuándo no gastar tokens): [`TESTING.md`](TESTING.md).
