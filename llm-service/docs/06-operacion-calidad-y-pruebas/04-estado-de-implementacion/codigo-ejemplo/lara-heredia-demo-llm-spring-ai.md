...
- Sin `curso_cohorte_id`/`usuario_ref`/`desafio_id` en las entidades — viola la regla de
  [02 · §7](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md) ("casi ninguna entidad existe fuera de un
  curso-cohorte").
...
[02 · §4](../../../02-arquitectura-y-plataforma/01-arquitectura-y-stack.md)).
