...
> capacidad de entregables ([30 · §1](../../../02-arranque-agil-y-sprint-0.md)).
>
...
>   ([29 · §5.3](../../../08-guia-de-historias-de-usuario.md)).
> - No se cargan las 24 h-persona de la primera Planning acá: van a **S1**
>   ([30 · §1.2](../../../02-arranque-agil-y-sprint-0.md)).
...
>   y son transversales al horizonte vigente ([5 sprints](../../../05-plan-de-cinco-sprints.md), no los 19
...
> [`35` · «Sprint 0»](../../../04-backlog-ejecutable.md).
...
| 3   | **Cálculo de capacidad de S1** hecho con la fórmula de §4 desde la planilla de disponibilidad y registrado en una copia de la [plantilla de sprint](../../../10-plantillas/sprint-llm.md) |           | ☐      |
...
| 10  | Remoto `tpi-llm` con `main` y `develop` creadas y **protegidas** (PR obligatorio, CI en verde, sin push directo ni force-push) según [GITFLOW](../../../../09-flujo-de-trabajo-del-equipo/01-gitflow.md) (§8)               |           | ☐      |
...
Los identificadores P1–P5 no suponen personas ya asignadas ([23 · §3](../../../03-plan-de-construccion-del-producto.md)).
...
integrante** en la planilla del equipo, no de un supuesto ([30 · §3](sprint-0.md)).
...
**pequeña, entendida por todos y con un recorrido completo** ([29 · §5.3](../../../08-guia-de-historias-de-usuario.md)).
...
> convierte a horas ([30 · §3.5](../../../02-arranque-agil-y-sprint-0.md)).
...
> integración real ([23 · §8](../../../03-plan-de-construccion-del-producto.md)).
...
- [ ] Protección en ambas: **PR obligatorio**, **CI en verde** para mergear, **sin push
  directo**, **sin force-push** ([GITFLOW](../../../../09-flujo-de-trabajo-del-equipo/01-gitflow.md), [flujo diario y Git](../../../../09-flujo-de-trabajo-del-equipo/02-workflow-diario.md)).
