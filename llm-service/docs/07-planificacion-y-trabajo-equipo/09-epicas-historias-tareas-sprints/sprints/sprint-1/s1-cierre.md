...
| 5 | ADR de arquitectura y convenciones | [`ep-01/h01.md`](../../tareas/ep-01/h01.md) T1–T5 | P1 | — (en paralelo a 1–4) | 16 | Cierre S1 | Borrador listo ([ADR-019](../../../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) + prueba ArchUnit) — falta PR y revisión (T5) |
| 6 | Confirmar `.env.example` + documentar `down` | [`ep-01/h02.md`](../../tareas/ep-01/h02.md) T3, T6 | P1 | H01·T3 (variables del ADR) | 7 | Cierre S1 | ✅ Confirmado 2026-09-16: `.env.example` y la documentación de `down`/health ya existían desde el 2026-09-12 (ítem 19 de `CORRECCIONES-SUGERIDAS.md`). El hueco real que quedaba era el volumen persistente de Postgres (T1) y la evidencia de CA3/CA4 (T4/T5) — cerrados en esta sesión, ver [`estado-de-implementacion/ep-01/h02.md`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h02.md) |
