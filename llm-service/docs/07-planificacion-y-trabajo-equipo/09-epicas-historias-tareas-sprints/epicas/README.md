...
> Taiga](../../10-plantillas/epica-taiga.md): *Objetivo*, *Suposiciones y Restricciones*,
...
> [`35` · «Épicas»](../../04-backlog-ejecutable.md)
> y en [30 · §4](../../02-arranque-agil-y-sprint-0.md). La tabla **Catálogo** de esta página
...
>   cierran cuando **todas sus historias** cumplen la DoD ([23 · §9.2](../../03-plan-de-construccion-del-producto.md)).
> - El template oficial de épica **no** usa `Como / Quiero / Para` ni escenarios BDD: eso
>   es exclusivo de las Historias de Usuario ([29 · §4](../../08-guia-de-historias-de-usuario.md),
>   [30 · §4](../../02-arranque-agil-y-sprint-0.md)).
...
>   épica** ([29 · §3 y §6](../../08-guia-de-historias-de-usuario.md)). La priorización a
...
> [21 · matriz de trazabilidad](../../../00-gobierno-y-evolucion/04-matriz-trazabilidad.md). Las parejas P1–P5 se
> definen en [23 · §3](../../03-plan-de-construccion-del-producto.md). Las fases F2 y F3 **no se
...
| **S4–S19** | ver catálogo y [plan de 5 sprints](../../05-plan-de-cinco-sprints.md) | *(a desglosar sprint a sprint)* | — |

> **S1–S3 pasaron de "a construir" a "auditar contra lo ya construido"** tras el commit
> `605f381` — ver [decision-605f381.md](../../../01-vision-alcance-y-entrega/03-entregas/decision-605f381.md) y
> [entrega-1.md](../../../01-vision-alcance-y-entrega/03-entregas/entrega-1.md).

Las historias de un sprint se derivan de la **receta** correspondiente en
[`35`](../../04-backlog-ejecutable.md) durante
