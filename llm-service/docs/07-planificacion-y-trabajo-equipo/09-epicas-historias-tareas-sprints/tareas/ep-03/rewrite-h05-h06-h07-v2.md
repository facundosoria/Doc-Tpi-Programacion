...
> [`backlog-priorizado-cierre-s1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/backlog-priorizado-cierre-s1.md)). Origen:
> [`checklist-cierre-s1.md` §3.1](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md) y
> [`estado-implementacion/ep-03/h05-h06-h07.md`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-03/h05-h06-h07.md)
...
- **Acotada:** 4 h · paso *documentación*. **Depende de:** T1 (mismo patrón de reescritura) ·
  **Traza:** [`estado-implementacion/ep-03/h05-h06-h07.md`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-03/h05-h06-h07.md).
...
- **Específica:** reemplazar en [`historias/ep-03/h03.md`](../../historias/ep-03/h03.md) (ex-H07) la
  ...
  cerrado según [`verificacion-v2-golden-set-calibracion.md` §2`](../../../../01-vision-alcance-y-entrega/03-entregas/verificacion-v2-golden-set-calibracion.md).
...
- **Específica:** escribir una verificación nueva, historia por historia (H05/H06/H07
  ...
  [`entregas/ep-03-s1-verificacion.md`](../../../../01-vision-alcance-y-entrega/03-entregas/ep-03-s1-verificacion.md), que
  [`decision-605f381.md`](../../../../01-vision-alcance-y-entrega/03-entregas/decision-605f381.md) ya declaró obsoleta.
...
- **Acotada:** 3 h · paso *documentación*. **Depende de:** T1–T3 · **Traza:**
  [`decision-605f381.md` · §5](../../../../01-vision-alcance-y-entrega/03-entregas/decision-605f381.md).

> **Total:** 14 h. No incluye [checklist §3.2](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md)
