...
> **Sin historia padre formal.** Igual que [`golden-set-update-proposal`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-03/golden-set-update-proposal.md)
> o [`synthetic-golden-set`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-03/synthetic-golden-set.md), esta pieza de código existe sin
...
> y es el ítem 4 de [`entregas/entrega-1.md` · §4](../../../../01-vision-alcance-y-entrega/03-entregas/entrega-1.md). Pareja **P2**
> (Modelos y resiliencia, [23 · §3](../../../03-plan-de-construccion-del-producto.md)). Formato del
...
- **Acotada:** 6 h · paso *adaptadores*. **Depende de:** — · **Traza:**
  [`model-deployments.md` · punto 1](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-02/model-deployments.md).
...
- **Relevante:** cierra uno de los "tres endpoints reales que no están en el contrato v2" que
  señala [`ep-01/h08.md`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h08.md).
- **Acotada:** 2 h · paso *contrato*. **Depende de:** T1 · **Traza:**
  [`checklist-cierre-s1.md` §2.5](../../../../01-vision-alcance-y-entrega/03-entregas/checklist-cierre-s1.md).
...
> [`backlog-priorizado-cierre-s1.md`](../../../../01-vision-alcance-y-entrega/03-entregas/backlog-priorizado-cierre-s1.md)): P2 tiene
...
- **Relevante:** cierra el segundo de los "dos endpoints del contrato v2 no implementados" que
  señala [`ep-01/h08.md`](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h08.md); sin esto, ADMIN sigue sin
...
- **Acotada:** 12 h · paso *caso de uso + seguridad (rol ADMIN)*. **Depende de:** T1 · **Traza:**
  [`model-deployments.md` · punto 3](../../../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-02/model-deployments.md).
