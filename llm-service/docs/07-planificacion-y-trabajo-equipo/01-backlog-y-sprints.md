...
> 18, y los bloqueantes de [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)
>
...
| E01-05 | Errores tipados según el contrato | Los cinco códigos de 18 §1.5 —`429`, `503`, `409`, `422`, `401`— salen con su `codigo` y su `trace_id`. Un test por código | 3 | E01-04 | 🔴 |
...
| E01-08 | Publicación de eventos al bus | Los cuatro eventos de 18 §2 salen con el schema acordado. Sin bus disponible se publican contra un stub local y quedan en la tabla de salida | 5 | E01-03 | 🔴 |
...
| ID | Historia | Criterio de aceptación | SP | Dep. | Prio |
|---|---|---|---|---|---|
| E03-01 | OpenAPI de los seis endpoints, publicado antes de implementar | El archivo está en el repo, cubre los seis de 18 §1.1 y **ningún endpoint más**. Cualquier otro es diseño interno | 5 | — | 🔴 |
...
| E05-08 | Publicar `score_de_ia_calculado` y `score_pendiente_diferido` | Con el schema de 18 §2.1 y §2.2. El segundo se emite cuando el proveedor está caído | 3 | E01-08 · E05-05 | 🔴 |
...
| E06-08 | Eventos `calibracion_aprobada` y `calibracion_fuera_de_tolerancia` | Con el schema de 18 §2.3, consumidos por el Tema 02 y el Tema 12 | 3 | E01-08 · E06-05 | 🟡 |
...
| E07-04 | Registro de incidentes y evento de jailbreak | Cada incidente queda registrado y publica `incidente_de_jailbreak` (RF-IA-10) con el schema de 18 §2.4 | 5 | E01-08 | 🟡 |
...
| E12-08 | Sesión de integración con la agenda de ocho ítems | Los ocho ítems de 18 §6 tratados, con acuerdo escrito por cada uno | 3 | 🔴 |
