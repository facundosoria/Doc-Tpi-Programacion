...
> [guía de cátedra de HU](08-guia-de-historias-de-usuario.md), las cinco piezas que la
...
> | Pieza | Fuente única |
> |---|---|
> | Sprint 0 y su checklist | [`35`](04-backlog-ejecutable.md) · sección «Sprint 0» |
> | DoR / DoD | [23 · §9.2](03-plan-de-construccion-del-producto.md)
> | Cálculo de capacidad | [23 · §2](03-plan-de-construccion-del-producto.md)
> | Catálogo de épicas | [`35`](04-backlog-ejecutable.md) · sección «Épicas» |
> | Historias de S1 (ID, épica, pareja, horas) | [`35`](04-backlog-ejecutable.md) · sección «S1» |
> | Historias de S1 en formato largo (Taiga) | [`historias/`](09-epicas-historias-tareas-sprints/historias/README.md)(por épica) · índice y demo en [`sprints/sprint-1/s1-historias.md`](09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-historias.md)
> | Tareas SMART por historia | [`tareas/`](09-epicas-historias-tareas-sprints/tareas/README.md)
> | Épicas (EP-01…EP-10) en formato Taiga, una por archivo | [`epicas/`](09-epicas-historias-tareas-sprints/epicas/README.md)
> | Acta del Sprint 0 | [`sprints/sprint-0/sprint-0.md`](09-epicas-historias-tareas-sprints/sprints/sprint-0/sprint-0.md)
> | Método para redactar/estimar HU | [29](08-guia-de-historias-de-usuario.md)
> | Templates de Taiga | [`plantillas/historia-de-usuario-taiga.md`](10-plantillas/historia-de-usuario-taiga.md)· [`plantillas/epica-taiga.md`](10-plantillas/epica-taiga.md)
>
...
| 3 | **Cálculo de capacidad de S1** hecho con la fórmula de §3 y registrado en una copia de la [plantilla de sprint](10-plantillas/sprint-llm.md) | ☐ |
| 4 | **DoR y DoD** ([23 · §9.2](03-plan-de-construccion-del-producto.md)) leídas y aceptadas por el equipo | ☐ |
| 5 | **Historia canónica** del equipo elegida y estimada ([29 · §5.3](08-guia-de-historias-de-usuario.md)); candidata: `LLM-S01-H06` | ☐ |
...
| 10 | Remoto `tpi-llm` con `main` y `develop` creadas y protegidas (PR obligatorio, CI en verde, sin push directo ni force-push) según [GITFLOW](../09-flujo-de-trabajo-del-equipo/01-gitflow.md). Las `feature/sNN/llm-sNN-hNN-<slug>` nacen de `develop` al arrancar cada historia de S1, no en Sprint 0 | ☐ |
...
aceptación, que son propios de cada una ([29 · §11](08-guia-de-historias-de-usuario.md)
...
7. Documentación y backlog reflejan lo entregado. La página del componente en la **Wiki de
   Taiga** está creada/actualizada según [27](07-guia-wiki-taiga.md): HU enlazadas por su
...
> La regla de no presentar una funcionalidad parcial como terminada está definida en el documento
> canónico de calidad y aceptación, [`03 — Plan de construcción del producto`](03-plan-de-construccion-del-producto.md#9-calidad-aceptación-y-operación-del-backlog).
> Este Sprint 0 la aplica al decidir qué entra en la Planning; no se copia aquí para evitar
> divergencias.
...
[38 · Plan de 5 sprints](05-plan-de-cinco-sprints.md)) estiman el trabajo de cada sprint en
...
([29 · §5–6](08-guia-de-historias-de-usuario.md)

---

## 4. Primeras épicas

La relación entre las diez épicas y las historias de las tres fases está definida una sola vez en
el [backlog ejecutable, sección «Épicas»](04-backlog-ejecutable.md#épicas): cada historia
`LLM-Sxx-Hyy` pertenece a una épica, el **sprint** dice *cuándo* se construye y la **épica** *para
qué sirve en el producto*. Las épicas **no se estiman ni se comprometen**; se cierran cuando todas
sus historias pasan la DoD. La tabla siguiente conserva la vista de entrega de Sprint 0 (pareja y
sprints), sin repetir la matriz de requisitos del backlog.
...
> **En Taiga** cada épica se carga con el [template oficial](10-plantillas/epica-taiga.md)
...
> *Dependencias / Impactos* (arrancan de [23 · §8](03-plan-de-construccion-del-producto.md)
...
> ([`epicas/README.md`](09-epicas-historias-tareas-sprints/epicas/README.md)), no en la ficha de Taiga.
...
valor** en el sentido de [29 · §3](08-guia-de-historias-de-usuario.md) (un docente percibe
el resultado). **H01–H04, H08 y H09** fallan la **V** de INVEST: son **tareas de sprint**, no
HU. En Taiga:

- **H05, H06, H07** → **HU** con el [template oficial](10-plantillas/historia-de-usuario-taiga.md)
...
> [backlog ejecutable](04-backlog-ejecutable.md). Las nueve
...
> épica en [`historias/ep-01/`](09-epicas-historias-tareas-sprints/historias/ep-01/README.md)y [`historias/ep-03/`](09-epicas-historias-tareas-sprints/historias/ep-03/README.md)
> (índice del sprint y demo en [`sprints/sprint-1/s1-historias.md`](09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-historias.md); tareas
> SMART en [`tareas/`](09-epicas-historias-tareas-sprints/tareas/README.md)); las diez épicas (EP-01…EP-10), una por archivo, en
> [`epicas/`](09-epicas-historias-tareas-sprints/epicas/README.md) — las activas en S1 son EP-01 y EP-03. El arranque como acta
> se registra en [`sprints/sprint-0/sprint-0.md`](09-epicas-historias-tareas-sprints/sprints/sprint-0/sprint-0.md)
