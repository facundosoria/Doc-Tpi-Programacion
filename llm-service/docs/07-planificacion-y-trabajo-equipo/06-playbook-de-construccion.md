...
Orden de precedencia: PRD e `idea.pptx.pdf`; `00-fuentes-de-verdad-y-convenciones.md`; contratos v1; decisiones aprobadas; este plan. El material de investigación y apoyo (`08-preguntas-investigacion-y-sincronizaciones/04-investigacion-y-material/`) es antecedente y puede contradecir las fuentes vigentes.
