...
> `Como / Quiero / Para`, sin puntos Fibonacci—: [`tareas/README.md`](../09-epicas-historias-tareas-sprints/tareas/README.md).
> La regla de la jornada y la distinción épica/historia/tarea:
> [29 · §4](../08-guia-de-historias-de-usuario.md) y
