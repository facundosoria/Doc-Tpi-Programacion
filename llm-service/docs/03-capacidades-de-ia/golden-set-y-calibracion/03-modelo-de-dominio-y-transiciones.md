...
> **Nota de evolución (2026-09-22).** Las decisiones D-07 a D-11, D-49, D-57, D-64 y D-161 introducen skills adjuntables,
> subcalibración jerárquica por desafío (`CourseBaseline` + `ChallengeOverlay`) y una rúbrica con
> dimensiones extendidas y subcriterios ponderables, que **no están representadas** en las tablas de
> entidades y estados de este documento. Ver, en orden:
> [05 — Skills: catálogo y formato](05-skills-catalogo-y-formato.md),
> [06 — Subcalibración jerárquica](06-subcalibracion-jerarquica.md),
> [07 — Rúbrica ponderada y subcriterios](07-rubrica-ponderada-y-subcriterios.md) (requiere
> [ADR-021](../../00-gobierno-y-evolucion/adr/ADR-021-rubrica-jerarquica-dimensiones-extendidas-y-subcriterios-ponderables.md))
> y [08 — Máquina de estados de corridas y activaciones](08-maquina-de-estados-corridas-y-activaciones.md)
> (reemplaza la fila `CalibrationRun`/`ActiveCalibration` de la tabla de Estados de este documento por
> tres agregados separados: `CalibrationRun`, `CalibrationActivation`, `CalibrationVerification`). Este
> documento no se reescribe porque la migración de dominio real está pendiente de aprobación explícita.
