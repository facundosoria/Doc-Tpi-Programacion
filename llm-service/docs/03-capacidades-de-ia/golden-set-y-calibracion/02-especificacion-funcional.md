...
> **Nota de evolución (2026-09-22 — D-57, D-64, [ADR-021](../../00-gobierno-y-evolucion/adr/ADR-021-rubrica-jerarquica-dimensiones-extendidas-y-subcriterios-ponderables.md)).**
> Para la **subcalibración por desafío**, D-57 decide que una subcalibración
> puede **agregar dimensiones nuevas** además de heredar y modificar las del curso (D-57), y que cada
> dimensión incorpora **subcriterios ponderables** internos (D-64). Esto contradice la regla cerrada de
> "cinco dimensiones fijas, sin subcriterios" que describe esta sección. La regla de esta sección sigue
> **vigente tal cual para la calibración global de curso** y para el modelo actualmente implementado;
> la evolución completa, su alcance exacto y sus pendientes de contrato/migración están documentados
> en [07 — Rúbrica ponderada y subcriterios](07-rubrica-ponderada-y-subcriterios.md) y en el ADR-021.
> No se reescribe esta sección porque la migración de dominio real está pendiente de aprobación
> explícita — ver ADR-021 §"Pendientes explícitos antes de implementar".
...
> **Nota de evolución (2026-09-22 — D-07 a D-11, D-49, D-161).** Las decisiones D-07 a D-11 y D-49
> amplían este modelo de asociación simple a un modelo de dos capas (`CourseBaseline` +
> `ChallengeOverlay` + `EffectiveEvaluationProfile`) con subcalibración por desafío, herencia editable,
> cascada de recalibración y una máquina de estados de tres agregados (`CalibrationRun`,
> `CalibrationActivation`, `CalibrationVerification`). Ver
> [06 — Subcalibración jerárquica](06-subcalibracion-jerarquica.md) y
> [08 — Máquina de estados de corridas y activaciones](08-maquina-de-estados-corridas-y-activaciones.md),
> que documentan íntegramente esa evolución y **reemplazan** la asociación simple descripta en esta
> sección para el flujo de desafíos/subcalibración. Esta sección permanece como referencia del modelo
> `ChallengeCalibrationAssignment` previo mientras no se congele el contrato del bloque 6.
