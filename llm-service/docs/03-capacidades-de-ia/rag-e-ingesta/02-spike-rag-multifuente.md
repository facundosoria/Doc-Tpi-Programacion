...
> ⚠️ Los enlaces `file:///d:/...` de esta sección apuntan a una ruta absoluta de Windows en la
> máquina donde se hizo el spike; `demoLLMSpringAi` no está en este repositorio, por lo que no
> resuelven para otro lector. Quedan como referencia textual del nombre de archivo, no como enlace
> navegable.
