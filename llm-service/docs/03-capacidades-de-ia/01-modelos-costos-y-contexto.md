...
> **Gobierno vigente.** Los modelos se asignan por función dentro de `llm-service`; la configuración se administra mediante `admin-service` y los contratos v1. Ningún proveedor, nombre de servicio o endpoint histórico de este análisis prevalece sobre [00](../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md)
...
> [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), Parte C, ítems E-19 a E-26.
...
envía solo.** El informe de gestión de modelos —[`presentaciones/informe-gestion-modelos.html`](../08-preguntas-investigacion-y-sincronizaciones/04-investigacion-y-material/presentaciones/informe-gestion-modelos.html)
...
> vez del estimado. Está anotado en [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), en el propio ADR-010.
...
que se suma encima de esta, sin reemplazarla — ver [08 P-12](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)
...
(techo global; el back office puede ajustarlo por alumno — [08 P-12](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)
...
Los pasos son los de [10](../01-vision-alcance-y-entrega/02-entregables-y-plan.md) Parte 2, §8. **La mitad no necesita ningún
...
> consulta legal de P-06 en [08](../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), no nosotros.
