...
> ítems que 17 — Mapa de integración §8
> (tabla I-01 a I-16) y 18 — Contratos inter-equipos §6
...
> [`docs/registro/`](../../registro/README.md) y, si tocan el schema, a
...
- [ ] Si I-04/I-05 cambian un payload: actualizar
      [`llm-service-v1.asyncapi.yaml`](../../contracts/llm-service.asyncapi.yaml) y avisar a
...
- [ ] Si I-14 fija el formato del token: agregar `security` al
      [`llm-service-v1.openapi.yaml`](../../contracts/llm-service.openapi.yaml).
