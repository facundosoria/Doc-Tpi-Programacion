...
> en el repo **hoy** contra las fichas escritas ([`../historias/`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/README.md)) y
> los invariantes del producto ([23 · §4.2](../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md)).
>
...
> en [`docs/estado-implementacion/`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/README.md) — ese tablero no repite
...
3. **Inmutabilidad de versiones publicadas**: no es solo una regla de servicio, es un
   **trigger de base de datos** (`prevent_published_version_mutation`) sobre
   ...
   aplicación. ✅ Cumple el invariante de [23 · §4.2](../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md):
...
8 semanas ya adelantó a S1 ([h01.md](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/ep-02/h01.md)). Falta, además de H10, el
...
[08](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)), hoy devuelve una lista vacía.
...
7. Unificar terminología: las historias dicen "cohorte", el código dice "curso" de punta a
   ...
   el curso-plantilla o la cohorte/oferta concreta ([08 · B-7](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)).
8. **Confirmar el invariante de pesos de la rúbrica.** [23 · §4.2](../../07-planificacion-y-trabajo-equipo/03-plan-de-construccion-del-producto.md)
   ...
   [`LLM-EP03-H04`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/ep-03/h04.md) (ex-S02-H01).
9. **Confirmar el alcance de calibración de plataforma vs. de curso.** La épica EP-04 describe
   ...
   [`LLM-EP04-H01`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/ep-04/h01.md) (ex-S03-H01).
