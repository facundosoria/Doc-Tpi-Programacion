...
>
> **Fuentes:** [`sprints/s1-cierre.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-cierre.md) (registro completo),
...
> [`08-decisiones-y-pendientes.md`](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) (decisiones ratificadas).
>
...
| A-5, P-02/C-5, P-05, P-07, P-08, P-09/P-10/P-11 | Ratificadas el 2026-09-12, ver [08](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md) |
...
[`ep-06/evaluacion-y-apelacion.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-06/evaluacion-y-apelacion.md))**.
...
- [ ] Disponibilidad declarada de cada integrante (tabla de la sección 2 de
      [`s1-cierre.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-cierre.md) — hoy con la referencia de 116,3 h/pareja, a
