...
> [`docs/estado-implementacion/`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/README.md).
...
**B-7** de [08 · decisiones y pendientes](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md): *"el material
