...
> pieza, cruzando la reprogramación a 8 semanas ([`../sprints/README.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/README.md))
...
> [`docs/sprints/s1-cierre.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-cierre.md) fila 7 y
> [`docs/estado-implementacion/ep-04/s03-h01.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-04/s03-h01.md).
...
1. **EP-02·H01** — puerto de invocación + fake ([ya con ficha](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/historias/ep-02/h01.md), 32 h, ex-H10).
...
- Actualizar terminología: "cohorte" → "curso" en toda la documentación de EP-03/EP-04, una
  vez confirmado con Franco qué representa `courseId` ([08 · B-7](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md)).
