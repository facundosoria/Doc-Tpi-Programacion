...
> **Qué es.** Los mismos 12 ítems del [Sprint Backlog de cierre](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-cierre.md),
...
> ([`ep-04/h01.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/tareas/ep-04/h01.md) T7,
> [`ep-02/model-catalog-real.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/tareas/ep-02/model-catalog-real.md),
> [`ep-01/h03.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/tareas/ep-01/h03.md) T9).
...
**La cátedra de este TP no es ese PO** — [00-fuentes-de-verdad-y-convenciones.md](../../00-gobierno-y-evolucion/01-fuentes-de-verdad-y-convenciones.md)
...
usa la tabla del [Sprint Backlog §4](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-cierre.md#4-historiastareas-comprometidas-y-dependencias).
...
T3/T5 de [`ep-01/h06.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/tareas/ep-01/h06.md) (~6 h) y unificar "cohorte"/"curso" en el resto
