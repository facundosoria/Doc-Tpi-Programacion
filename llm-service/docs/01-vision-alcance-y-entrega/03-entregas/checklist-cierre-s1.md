...
> [`sprints/s1-historias.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-historias.md) — no según lo que terminó construido.
> Nace del cruce entre esa ficha y el tablero de estado real en
> [`estado-implementacion/`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/README.md) (auditado 2026-09-12).
>
...
- [ ] Se probó siguiendo la guía al pie de la letra, en el ambiente integrado (no en una máquina
      aislada) — así lo exige [`sprints/s1-historias.md` · Demo de S1](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-historias.md).

**Evidencia del hueco:** [`estado-implementacion/ep-01/h09.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h09.md) —
...
- [ ] El pipeline mide cobertura y **falla** si baja del 95 % acordado en
      [`24-convenciones-cobertura.md`](../../06-operacion-calidad-y-pruebas/02-convenciones-de-cobertura.md).
...
**Evidencia del hueco:** [`estado-implementacion/ep-01/h03.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h03.md) —
...
**Evidencia:** [`estado-implementacion/ep-01/h01.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h01.md).
...
**Evidencia:** [`estado-implementacion/ep-01/h03.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h03.md) — hoy
...
**Evidencia:** [`estado-implementacion/ep-01/h02.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h02.md).
...
**Evidencia:** [`estado-implementacion/ep-01/h08.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h08.md) — sin
...
- [x] **Decidido el 2026-09-12: se marca como histórico/reemplazado por v2** — el código ya
      ...
      [`ep-01/h05.md` T1 (ex-H08)](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/tareas/ep-01/h05.md).
...
**Evidencia:** [`estado-implementacion/ep-01/h08.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h08.md),
[`estado-implementacion/ep-03/s02-h02.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-03/s02-h02.md),
[`estado-implementacion/ep-02/model-deployments.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-02/model-deployments.md).
...
**Evidencia:** [`estado-implementacion/ep-03/h05-h06-h07.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-03/h05-h06-h07.md),
...
- [ ] Confirmar con quien mantiene el módulo (Franco Brizzio) si `courseId` es el
      ...
      [`08-decisiones-y-pendientes.md`](../../00-gobierno-y-evolucion/02-decisiones-y-pendientes.md), todavía abierta).
...
**Evidencia:** [`estado-implementacion/README.md` · "El hallazgo transversal más importante"](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/README.md).
...
- **H04** (esquema versionado con auditoría) — 🟢 cumple las 5 CA.
  [`estado-implementacion/ep-01/h04.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/h04.md)
- **H10** (puerto hacia modelos + fake) — 🟢 cumple las 6 tareas, cerrada 2026-09-12.
  [`estado-implementacion/ep-02/h10.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-02/h10.md)
...
- [ ] Actualizar [`estado-implementacion/README.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/README.md) y las
      filas de [`estado-implementacion/ep-01/README.md`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/ep-01/README.md)
...
[`sprints/s1-historias.md`](../../07-planificacion-y-trabajo-equipo/09-epicas-historias-tareas-sprints/sprints/sprint-1/s1-historias.md) o de un hallazgo ya auditado en
[`estado-implementacion/`](../../06-operacion-calidad-y-pruebas/04-estado-de-implementacion/README.md). Cuando se resuelva un ítem, el
